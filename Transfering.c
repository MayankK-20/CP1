...
void parallel_for(int low, int high, auto lambda, int numThreads) {
    parallel_for(low,high,-1,-1, lambda, numThreads);
}

// Parallel programming for 2D loop
void parallel_for(int low1, int high1, int low2, int high2, auto lambda, int numThreads) {
    numThreads --;
